            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel ">
                    ...
                    <ul class="collapse" id="component-nav">
                        ...
                        <li class=""><a href="button.html"><i class="icon-angle-left"></i> ایجاد کتاب
                                جدید </a></li>
                        <li class="active"><a href="icon.html"><i class="icon-angle-left"></i> نمایش و مدیریت
                                کتب </a></li>
                ...
                <li class="panel ">
                    ...
                    <ul class="collapse" id="form-nav">
                        <li class=""><a href="forms_general.html"><i class="icon-angle-left"></i> ایجاد مرکز جدید
                            </a></li>
                        <li class=""><a href="forms_advance.html"><i class="icon-angle-left"></i>
                ...
                <li class="panel">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle"
                        ...
                        <i class="icon-table"></i> مدیریت مالفین
                    ...
                    <ul class="collapse" id="pagesr-nav">
                        <li><a href="pages_calendar.html"><i class="icon-angle-left"></i> ایجاد مالف جدید </a></li>
                        <li><a href="pages_timeline.html"><i class="icon-angle-left"></i>نمایش و مدیریت مالفین </a></li>
                ...
                <li class="panel">
                    ...
                    <ul class="collapse" id="chart-nav">
                        ...
                        <li><a href="charts_bar.html"><i class="icon-angle-left"></i>  نمایش و مدیریت مترجمین</a></li>
                    </ul>
                </li>
