                ...
                <div class="col-md-6 mb-5 mb-md-0">
                    ...
                    <table class="table table-bordered mb-2">
                        ...
                        <div class="bg-light p-2">
                            <p class="p-0 m-0 fs-10 lh-lg" style="text-align: justify;">لورم ایپسوم متن ساختگی با تولید
                                سادگی
                        ...
                        <div class="text-end mt-1">
                            <button type="submit" name="BtnSave" class="btn site-btn  mb-5">پرداخت آنلاین</button>
                        </div>
                    </div>
                </div>
            </div>
