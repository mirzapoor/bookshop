    ...
    @endif
            ...
            <div class="row">
                <div class="col-lg-12 marginrl">
                    {!! Form::open(['url' => '/admin/chaphkoneh', 'class' => 'form-horizontal']) !!}
                    <div class="form-group">
                        {{ Form::label('name_chapkhonehs', 'نام چاپخانه', ['class' => 'control-label cal-lg-3']) }}
                        <div class="col-lg-7">
                    ...
                    <div class="form-group " style="margin-left: 50px">
                        {{ Form::label('website_chapkhonehs', 'نشانی وبسایت چاپخانه  ', ['class' => 'control-label cal-lg-3']) }}
                    </div>
                    <div class="form-group input-group col-lg-7">
                        {!! Form::text('website_chapkhonehs', null, ['class' => 'form-control', 'placeholder' => ' نشانی وبسایت چاپخانه را وارد کنید.']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            {!! Form::textarea('address_chapkhonehs', null, ['class' => 'form-control', 'id' => 'cleditor', 'placeholder' => 'آدرس چاپحانه را وارد کنید .']) !!}
                        </div>
                    </div>

                    <div class="form-group">
                        {{ Form::label('details_chapkhonehs', 'توضیحات', ['class' => 'control-label cal-lg-3']) }}
                        <div class="col-lg-7">
                            {!! Form::textarea('details_chapkhonehs', null, ['class' => 'form-control', 'id' => 'cleditor', 'placeholder' => 'توضیحات مربوط به  چاپخانه را وارد کنید .']) !!}
                        </div>
                    </div>
