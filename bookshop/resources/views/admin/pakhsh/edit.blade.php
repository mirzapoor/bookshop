...
@section('content')
    <div id="content">
        <div class="inner" style="min-height:700px;">
            <div class='col-lg-12'>
                <div class="row">
                    <h1>ویرایش اطلاعات مرکز پخش <span style=" color:red; font-size:40px;">{{ $record->name_pakhsh }}</span>
                    </h1>
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-lg-12 marginrl">
                    {!! Form::model($record, ['method' => 'PATCH', 'route' => ['pakhsh.update', $record->id], 'files' => true]) !!}
