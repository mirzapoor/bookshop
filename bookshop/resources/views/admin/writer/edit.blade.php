    ...
    <div id="content">
        <div class="inner" style="min-height:700px;">
            <div class='class-lg-12'>
                <div class="row">
                    <h1>ویرایش اطلاعات نویسندگان <span style=" color:red; font-size:40px;">{{ $record->name_writers }}
                            {{ $record->lname_writers }} </span>
                    </h1>
                </div>
            </div>
            <hr>
            ...
            <div class="row">
                <div class="col-lg-12 marginrl">
                    {!! Form::model($record, ['method' => 'PATCH', 'route' => ['writer.update', $record->id], 'files' => true]) !!}
                    ...
                    <div class="form-group " style="margin-left: 50px">
                        {{ Form::label('website_writers', 'نشانی وب سایت نویسنده  ', ['class' => 'control-label cal-lg-3']) }}
                    </div>
                    <div class="form-group input-group col-lg-7">
                        {!! Form::text('website_writers', null, ['class' => 'form-control', 'placeholder' => ' نشانی وب سایت نویسنده را وارد کنید.']) !!}
                ...
                <div class="form-group">
                    {{ Form::label('details_writers', 'توضیحات نویسنده', ['class' => 'control-label cal-lg-3']) }}
                    <div class="col-lg-7">
                        {!! Form::textarea('details_writers', null, ['class' => 'form-control', 'placeholder' => '  توضیحان نویسنده را وارد کنید.']) !!}
                    </div>
                </div>
