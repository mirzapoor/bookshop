        ...
        <div class="inner" style="min-height:700px;">
            ...
            <div class="row">
                <div class="col-lg-12 marginrl">
                    {!! Form::open(['url' => '/admin/translator', 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="form-group " style="margin-left: 50px">
                        {{ Form::label('website_motarjems', 'نشانی وب مترجم  ', ['class' => 'control-label cal-lg-3']) }}
                    </div>
                    <div class="form-group input-group col-lg-7">
                        {!! Form::text('website_motarjems', null, ['class' => 'form-control', 'placeholder' => ' نشانی وب مترجم را وارد کنید.']) !!}
                    ...
                    <div class="form-group">
                        {{ Form::label('details_motarjems', 'توضیحات', ['class' => 'control-label cal-lg-3']) }}
                        <div class="col-lg-7">
                            {!! Form::textarea('details_motarjems', null, ['class' => 'form-control', 'id' => 'cleditor', 'placeholder' => 'توضیحات مربوط به  مترجم را وارد کنید .']) !!}
                        </div>
                    </div>
