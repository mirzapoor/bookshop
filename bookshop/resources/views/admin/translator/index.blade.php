                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabe"> {{ $translator2->name_motarjems }} {{ $translator2->lname_motarjems }}</h4>
                                        </div>
                                        <div class="modal-boby" style="margin-right: 10px">
                                            ...
                                            <p> ایمیل : {{ $translator2->email_pakhsh }} </p>
                                            <p> نشانی وب سایت : <a href="http://www.{{ $translator2->website_motarjems }}"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="H2">آیا از حذف کردن
                                                    {{ $translator3->name_motarjems }}  {{ $translator3->lname_motarjems }}اطمینان دارید؟</h4>
                                            </div>
                                            <div class="modal-baby">
                                                <P> {{ $translator3->details_motarjems }}</P>
                                            </div>
                                            <div class="modal-footer">
                                                <form method="POST" action="<?= Url('admin/translator/' . $translator3->id) ?>">
